...
import { Home, MessageSquare, ThumbsUp, Search, Plus, Lock, Brain, Gamepad2, BookOpen, MessageCircle } from 'lucide-vue-next'
...
const sidebarItems = computed(() => [
  ...
  { icon: markRaw(Brain), label: t('nav.vocational_tests') || 'Tests', href: '/postulante/test' },
  { icon: markRaw(Gamepad2), label: t('postulante.labyrinth') || 'Laberinto', href: '/postulante/laberinto' },
  { icon: markRaw(BookOpen), label: t('postulante.digital_log') || 'Bitácora', href: '/postulante/bitacora' },
  { icon: markRaw(MessageCircle), label: t('postulante.p2p_connection') || 'Conexión P2P', href: '/postulante/p2p' },
  { icon: markRaw(MessageSquare), label: 'Foro UTP+', href: '/postulante/foro' },
]);
