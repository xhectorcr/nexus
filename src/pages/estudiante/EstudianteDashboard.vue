  ...
  >
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 gap-5 md:grid-cols-4">
        <Card v-for="(stat, i) in stats" :key="i" class="group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 border border-black overflow-hidden relative">
          ...
          <CardContent>
            <div class="mt-4 space-y-3">
              <div
                ...
                :key="i"
                class="group flex items-start gap-4 p-4 rounded-xl border border-black hover:border-black hover:shadow-md transition-all duration-300 bg-white relative overflow-hidden"
              >
                <!-- Urgent accent line -->
